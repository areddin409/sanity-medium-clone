...
function Post({ post }: Props) {
  ...
  return (
    <main>
      ...
      {submitted ? (
        <div className='flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl rounded-lg mx-auto'>
        ...
        >
          ...
          <input
            type='submit'
            className='shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer'
          />
        </form>
      )}
...
body
  ...
  return {
    ...
    revalidate: 60 //after 1 hour, it'll update the old cache version
  };
};
